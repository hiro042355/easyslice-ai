...
const telemetry = (stage: "PLAYER" | "GVS" | "MEDIA" | "HLS_MANIFEST" | "HLS_FRAGMENT" | "UNKNOWN" = "UNKNOWN") => {
  ...
  collector.processEvidence({ tokenContext: stage === "GVS" ? "GVS" : stage === "PLAYER" ? "PLAYER" : "UNKNOWN",
    ...
    tokenRetrievedByYtDlp: stage === "UNKNOWN" ? "UNKNOWN" : "YES", tokenAttachedToOutboundRequest: "UNKNOWN",
    tokenConsumedByYtDlp: "UNKNOWN", botCheckRelativeToTokenRetrieval: "UNKNOWN",
    botCheckRelativeToTokenAttachment: "UNKNOWN", gvsRequestReached: stage === "GVS" || stage === "MEDIA" ? "YES" : "UNKNOWN",
...
test("Worker projects only the closed safe post-provider process failure evidence", () => {
  ...
  assert.deepEqual(projectAcquisitionWorkerYtDlpFailure(error, telemetry()), {
    ...
    tokenRetrievedByYtDlp: "UNKNOWN",
    tokenSelectionObserved: "UNKNOWN",
    tokenSelectionCoverage: "UNKNOWN",
    tokenApplicationObserved: "UNKNOWN",
    tokenApplicationCoverage: "UNKNOWN",
    tokenApplicationTarget: "UNKNOWN",
    tokenApplicationTemporalRelation: "UNKNOWN",
    relevantOutboundRequestObserved: "UNKNOWN",
    relevantOutboundRequestCoverage: "UNKNOWN",
    tokenAppliedToRelevantOutboundRequest: "UNKNOWN",
    tokenAttachedToOutboundRequest: "UNKNOWN",
    tokenConsumedByYtDlp: "UNKNOWN",
    botCheckRelativeToTokenRetrieval: "UNKNOWN",
