...
const bootstrapFailure = Object.freeze({
  ...
  impersonationHttpResponse: "UNKNOWN",
  impersonationResponseSchema: "UNKNOWN",
  impersonatedTokenPresent: "UNKNOWN",
  impersonatedExpiryValid: "UNKNOWN",
  credentialCacheAssigned: "UNKNOWN",
  getAccessTokenReturned: "UNKNOWN",
  accessTokenAccepted: "UNKNOWN",
  outerGetClientStarted: "UNKNOWN",
  outerClientResolved: "UNKNOWN",
  outerGetAccessTokenInvoked: "UNKNOWN",
  outerContinuationEntered: "UNKNOWN",
  projectIdResolutionStarted: "UNKNOWN",
  cloudResourceManagerRequestStarted: "UNKNOWN",
  cloudResourceManagerResponseObserved: "UNKNOWN",
  cloudResourceManagerProjectIdPresent: "UNKNOWN",
