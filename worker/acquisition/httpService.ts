    ...
    if (request.method === "POST" && request.url === "/v1/acquisitions") {
      ...
      dependencies.log({
        ...
        ...(diagnostic ? {
          ...
          tokenSelectionObserved: diagnostic.tokenSelectionObserved,
          tokenSelectionCoverage: diagnostic.tokenSelectionCoverage,
          tokenApplicationObserved: diagnostic.tokenApplicationObserved,
          tokenApplicationCoverage: diagnostic.tokenApplicationCoverage,
          tokenApplicationTarget: diagnostic.tokenApplicationTarget,
          tokenApplicationTemporalRelation: diagnostic.tokenApplicationTemporalRelation,
          relevantOutboundRequestObserved: diagnostic.relevantOutboundRequestObserved,
          relevantOutboundRequestCoverage: diagnostic.relevantOutboundRequestCoverage,
          tokenAppliedToRelevantOutboundRequest: diagnostic.tokenAppliedToRelevantOutboundRequest,
          ...
          botCheckEvidenceKind: diagnostic.botCheckEvidenceKind,
          ytDlpProcessTerminated: diagnostic.ytDlpProcessTerminated,
          providerRequestObservationCoverage: diagnostic.providerRequestObservationCoverage,
          providerRequestCount: diagnostic.providerRequestCount,
          providerTokenDemandObserved: diagnostic.providerTokenDemandObserved,
          providerResponseObserved: diagnostic.providerResponseObserved,
          providerResponseSchemaOutcome: diagnostic.providerResponseSchemaOutcome,
